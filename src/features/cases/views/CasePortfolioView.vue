  ...
  <div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
      ...
      <div class="flex gap-3">
        ...
        <button class="px-4 py-2 bg-primary text-white rounded-md text-sm font-semibold hover:bg-red-700 transition shadow-sm flex items-center gap-2">
            ...
            >
              ...
              <td class="px-6 py-4 text-center">
                <span 
                  ...
                  :class="item.status === 'OPEN' ? 'bg-blue-50 text-blue-700 border-blue-100' : 'bg-slate-100 text-slate-600 border-slate-200'"
                >
                  {{ item.status }}
                </span>
              </td>
