...
const navItems = computed(() => [
  ...
  { group: 'Compliance', items: [
    ...
    { name: 'System Control', path: '/system', icon: 'settings', disabled: true },
  ]}
])
</script>
...
<template>
  <aside class="w-[260px] bg-slate-900 border-r border-slate-800 flex flex-col shrink-0 z-20 text-slate-300 transition-all duration-300">
    ...
    <div class="px-6 flex gap-2 mb-8">
       ...
       <button class="flex-1 py-2 px-3 bg-primary text-white text-xs font-medium rounded hover:bg-red-700 transition shadow-lg shadow-red-900/20">
         New Case
       </button>
    </div>
